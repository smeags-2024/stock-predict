...
class RiskManager {
   public:
     ...
     * @return VaR value
     */
    static double calculate_var(const std::vector<double>& returns, double confidence_level = 0.95,
     ...
     */
    static double calculate_volatility(const std::vector<double>& returns, int trading_days = 252);
...
class PortfolioOptimizer {
   public:
     ...
     */
    static std::vector<Portfolio> efficient_frontier(
        const std::vector<std::vector<double>>& returns,
        const std::vector<std::string>& asset_names, int num_points = 50);
...
class PositionSizer {
   public:
     ...
     */
    static double fixed_fractional(double capital, double risk_fraction, double entry_price,
                                   double stop_loss);
