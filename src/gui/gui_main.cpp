...
int main(int argc, char *argv[])
{
    ...
    QCommandLineOption symbolOption(QStringList() << "s" << "symbol",
                                   "Initial stock symbol to load (default: AAPL)",
                                   "symbol", "AAPL");
    parser.addOption(symbolOption);
    
    QCommandLineOption modelOption(QStringList() << "m" << "model",
                                  "Initial model type (ensemble, lstm, transformer)",
                                  "model", "ensemble");
    ...
    QCommandLineOption gpuOption(QStringList() << "g" << "gpu",
    ...
    splash.showMessage("Initializing Stock Prediction System...", Qt::AlignBottom | Qt::AlignCenter, Qt::black);
    app.processEvents();
    
    try {
        // Initialize the main window
        splash.showMessage("Loading main interface...", Qt::AlignBottom | Qt::AlignCenter, Qt::black);
        app.processEvents();
