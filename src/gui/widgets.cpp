...
void SettingsDialog::loadSettings() {
    ...
    primary_source_combo_->setCurrentText(settings.value("primary_source", "Yahoo Finance").toString());
...
void AboutDialog::setupUI() {
    ...
    logo_label->setPixmap(QPixmap(":/icons/app_icon.png").scaled(64, 64, Qt::KeepAspectRatio, Qt::SmoothTransformation));
